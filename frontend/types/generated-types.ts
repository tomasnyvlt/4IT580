...
export type ConfirmRegMutation = {
  __typename?: "Mutation";
  confirmRegistration: { __typename?: "LoginTokens"; accessToken: string; refreshToken: string };
};
...
export type LoginMutationMutation = {
  __typename?: "Mutation";
  login: { __typename?: "LoginTokens"; accessToken: string; refreshToken: string };
};
...
export type MatchDetailQuery = {
  ...
  match: {
    ...
    state: Match_State;
    edit_hash: string;
    id_league?: number | null;
    Match?: Array<{ __typename?: "Team"; id_team?: number | null; name?: string | null } | null> | null;
  };
};
...
export type TeamDetailQuery = {
  ...
  team: {
    ...
    players: Array<{ __typename?: "User"; firstName: string; lastName: string }>;
    invited_players: Array<{ __typename?: "User"; firstName: string }>;
    admins: Array<{ __typename?: "User"; firstName: string }>;
    team_meta_data: Array<{ __typename?: "Team_meta_data"; key: string; value?: string | null }>;
    matches?: Array<{
      __typename?: "Match";
      id_match: number;
      time_created?: string | null;
      ...
      id_league?: number | null;
      season: Seasons;
      teams?: Array<{ __typename?: "Team"; name?: string | null } | null> | null;
    } | null> | null;
  };
};
...
export type UserQuery = {
  ...
  user: {
    ...
    teams: Array<{
      ...
      name?: string | null;
      image_url?: string | null;
      players: Array<{ __typename?: "User"; firstName: string; lastName: string; id: number }>;
    }>;
  };
};
 ...
 * });
 */
export function useConfirmRegMutation(
  baseOptions?: Apollo.MutationHookOptions<ConfirmRegMutation, ConfirmRegMutationVariables>
) {
 ...
 * });
 */
export function useMatchAddMutation(
  baseOptions?: Apollo.MutationHookOptions<MatchAddMutation, MatchAddMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useRegisterMutationMutation(
  baseOptions?: Apollo.MutationHookOptions<RegisterMutationMutation, RegisterMutationMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<RegisterMutationMutation, RegisterMutationMutationVariables>(
...
export function useMatchDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MatchDetailQuery, MatchDetailQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useTeamDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TeamDetailQuery, TeamDetailQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
